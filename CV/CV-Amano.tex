...
\setmainfont[AutoFakeSlant=0.25]{Noto Serif}
\setsansfont[AutoFakeSlant=0.25]{Noto Sans}
...
\GeneralEntry{14em}{28em}{Jan. 1, 2026 - present}
{\textbf{Professor}\\
	Department of Earth and Planetary Science,\\
	Graduate School of Science, The University of Tokyo}

\GeneralEntry{14em}{28em}{Aug. 1, 2016 - Dec. 31, 2025}
...
\begin{enumerate}
	...
	{Paris, France, Oct. 23, 2025}

	\TalkEntry
	{Bridging the gap between fluid and kinetic simulations}
	{International School/Symposium for Space Simulation (ISSS-15)}
	{Garching, Aug. 5, 2024}
